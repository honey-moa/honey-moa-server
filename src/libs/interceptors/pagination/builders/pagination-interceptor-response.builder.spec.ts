...
import { OffsetPaginationQueryDto } from '@libs/api/dtos/offset-pagination-query.dto';
...
describe(PaginationResponseBuilder.name, () => {
  ...
  describe(PaginationResponseBuilder.prototype.offsetPaginationResponseBuild
    .name, () => {
    let res: { data: any };
    ...
    it('data is not array type', () => {
      ...
      expect(() => builder.offsetPaginationResponseBuild(res, pageDto)).toThrow(
